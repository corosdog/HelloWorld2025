...
class MainApp:
    ...
    def create_widgets(self):
        check_budg_img = Image.open('Check_Budget_Icon.jpg').resize((300, 300))
        ...
        add_spending_img = Image.open('Add_Spending_Icon.jpeg').resize((300, 300))
        ...
        calc_icon_img = Image.open('Calculator_Icon.png').resize((300, 300))
