...
class MainApp:
    ...
    def create_widgets(self):
        check_budg_img = Image.open('Check_Budget_Icon.jpeg').resize((200, 200))
        ...
        add_spending_img = Image.open('Add_Spending_Icon.jpeg').resize((200, 200))
        ...
        calc_icon_img = Image.open('Calculator_Icon.jpeg').resize((200, 200))
        ...
        calc_button.grid(row=0, column=2, padx=0, pady=0)
